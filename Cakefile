...
file = 'SwiftCodeGenerator.coffee'
identifier = 'com.codedbydan.PawExtensions.SwiftCodeGenerator'
...
test = (callback) ->
    ...
    child = exec "set -o pipefail && (cd SwiftCodeGeneratorTests; swift test | xcpretty -c)"
...
clean = () ->
    ...
    exec "rm -Rf SwiftCodeGeneratorTests/.build/"
